...
Forking copies the repo on Git to your account and allows you to push and make changes.  Cloning copies the code to your
...
2.  Once the source repo has been copied, clone it from your account
...
5.  Once the pull request has been created, then the owner of the source acc
